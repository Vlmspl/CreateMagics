...
import net.vastless.create_magics.block.custom.mana_powered_motor.ManaPoweredMotorBlockEntity;
import net.vastless.create_magics.block.custom.mana_powered_motor.ManaPoweredMotorRenderer;
import net.vastless.create_magics.block.custom.mana_storage.ManaStorageBlockEntity;
import net.vastless.create_magics.block.custom.mana_storage.ManaStorageRenderer;
...
public class ModBlockEntities {
    ...
    public static final BlockEntityEntry<ManaStorageBlockEntity> MANA_STORAGE_BLOCK_ENTITY = CreateMagics.REGISTRATE
            .blockEntity("mana_storage", ManaStorageBlockEntity::new)
